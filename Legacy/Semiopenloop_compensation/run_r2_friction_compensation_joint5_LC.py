...
load_cell = load_cell_listener.r2_load_cell()
...
#---------------------------------------------------------------------------------------
                ...
                if motor_velocity > 0:
                    ...
                    if load_cell.load_cell_slope[0] < -1000:  # moving right
                        control_torque = target_torque + coulomb_offset
                    elif load_cell.load_cell_slope[0] > 1000:  # moving left
                        control_torque = target_torque - coulomb_offset
                    else:
