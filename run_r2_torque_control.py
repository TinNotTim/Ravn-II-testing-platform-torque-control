...
while working==1:
    ...
    if count_interval_cmd >= 100: 
        ...
        if input_key == '9':
            r2_tor_ctl.pub_state_command('pause')
    ...
    # Joint 1
        ...
        count_interval_cmd=101 # this is to skip the keyboard control interval repetitive commands so that the torque increase will only run once.
